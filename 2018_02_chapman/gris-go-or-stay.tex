...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{.5\linewidth}
      \begin{figure}
        \includegraphics[height=3cm]{no-ice-sheet-models}
      \end{figure}
      \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}[c]
    \begin{column}{.5\linewidth}
      \begin{figure}
        \includegraphics[height=6cm]{hirham_temp}
        \caption{2-m air temperature}
      \end{figure}
    \end{column}
    \begin{column}{.5\linewidth}
      \begin{figure}
        \includegraphics[height=6cm]{hirham_precip}
