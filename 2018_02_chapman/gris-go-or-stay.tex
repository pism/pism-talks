...
\begin{frame}{Observed flow speeds}
    \begin{figure}
      \includegraphics[width=0.4\textwidth]{greenland-exp-overview-oldbed}
      \includegraphics[width=0.4\textwidth]{calib-speed-sia}
    \end{figure}
\end{frame}
...
\begin{frame}
 ...
 \includemedia[
    ...
    addresource=../sound/should_i_stay.mp3,
    activate=onclick,
    deactivate=onclick,
  ]{Stay}{../sound/should_i_stay.mp3}
\end{frame}
