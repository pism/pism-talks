...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item isostatic rebound does little to slow down mass loss
  \end{itemize}
\end{frame}
...
\setbeamertemplate{background canvas}
  {
     \tikz{\node[inner sep=0pt,opacity=0.5] {\includegraphics[height=\paperheight,width=\paperwidth]{gris-green-collage-clean}};}
} 

\begin{frame}{Summary}
  \begin{transbox}
    \begin{itemize}
    \item We have performed the first millennium scale projections with an \emph{outlet glacier-resolving} ice sheet model 
  ...
  \note[item]{Did I waste my time doing this work? You be the judge}
\end{frame}
