...
{Understanding ice sheets\\through observations and models}
%\subtitle{Understanding ice sheet response to climate change through observations and models}

\author[Aschwanden] % (optional, use only with lots of authors)
{Andy Aschwanden\\Geophysical Institute\\University of Alaska Fairbanks}
...
\titlegraphic{\vskip-1.cm\includegraphics[height=3cm]{grn1km_speed_slr}}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[height=5cm]{grn1km_speed_slr}
  \end{figure}
\end{frame}
