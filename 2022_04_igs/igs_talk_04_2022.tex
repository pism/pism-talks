...
\documentclass[hide notes,intlimits,aspecratio=169]{beamer}
\mode<presentation>
{
...
\setbeamertemplate{background canvas}
  ...
  \begin{frame}
    \begin{figure}
      \includegraphics[height=4cm]{fire-alarm}
    \end{figure}
    \begin{figure}
      \includegraphics[height=4cm]{fire-truck}
    \end{figure}
\end{frame}
...
\part{The bad\\[2em] \includegraphics[height=3cm]{thebad}}
