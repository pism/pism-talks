...
\begin{frame}{Where are the projections?}
  \begin{block}{Now that we have outlet glaciers, we could do new projections}
    \begin{itemize}
    \item century-scale projections: issues with model initialization
    \item need to understand the role of outlet glaciers in the long term evolution of the GrIS
...
\begin{frame}
  \begin{columns}
    ...
    \vspace{3em}
    \begin{figure}
      \includegraphics[width=5.5cm]{ts_glacial}
  \end{figure}
\end{columns}
\end{frame}
