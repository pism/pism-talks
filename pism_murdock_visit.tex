...
\begin{frame}[plain]
  ...
  \begin{transbox}[0.6]
    ...
    \end{itemize}
    \begin{figure}  % better figure coming
      \includegraphics[width=5cm]{gris-grace-trend} \\
      (better figure coming)
  \end{figure}
  \end{transbox}
\end{frame}
...
\begin{frame}{The Parallel Ice Sheet Model (PISM) is\ldots}
  ...
  \item being developed at UAF since 20XX
...
\begin{frame}{Computational needs}
coming soon: typical no. of cores and wallclock hours needed for high-resolution simulations
\end{frame}
