...
\setbeamertemplate{background canvas}
  {
     \tikz{\node[inner sep=0pt,opacity=1.] {\includegraphics[width=\paperwidth]{uaf_beamer_shade_galen}};}
} 
...
\begin{frame}
  \begin{figure}
    \includegraphics<1>[height=8cm]{gurschengletscher-l}
    \includegraphics<2>[height=8cm]{gurschengletscher}
  \end{figure}
\end{frame}
