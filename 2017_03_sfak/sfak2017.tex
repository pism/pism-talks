...
\begin{frame}{Muir Glacier, Alaska}
  \flashmovie[width=\paperwidth]{documenting_glacial_change.swf}
\end{frame}
...
\begin{frame}{Melting Glaciers in Alaska: Columbia Glacier}
  ...
  \note[item]{that they had to reposition the camera twice}
\end{frame}
...
\begin{frame}{Ice Cores: The 2-mile Time Machine}
  ...
  \note[item]{What is an ice core and how does it work}
  ...
  \note[item]{building layer afer layer, as you can see in the photo here}
