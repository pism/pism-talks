...
\begin{frame}{Glaciers Worldwide}
  \begin{itemize}
...
\begin{frame}{What if they melted completely?}
  \begin{itemize}
  \item all glaciers except Greenland and Antartic ice sheets: 1\,m (3\,ft)
  \item Greeland: 6\,m (20\,ft)
  \item Antartica: 60\,m (200\,ft)
  \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{figure}
      \movie[showcontrols=true,autostart,loop,width=8cm]{\includegraphics[width=8cm]{alley-001}}{alley-milankovitch.mov}
    \end{figure}
\end{frame}
