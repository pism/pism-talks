...
\begin{frame}[plain]
  ...
  \note[item]{That's why I became a glaciologist}
\end{frame}
...
\begin{frame}{So what makes the past 100\,yrs so special}
  ...
  \end{figure}
  \note[item]{Call it temperature change instead of anomaly}
...
\begin{frame}{Is the sun driving today's warming?}
  \begin{figure}
...
\begin{frame}{What does this mean}
  \begin{figure}
    ...
    \includegraphics<3>[width=\textwidth]{sea-level-potential-liberty-01}
  \end{figure}
...
\begin{frame}{West Antartica in the News}
