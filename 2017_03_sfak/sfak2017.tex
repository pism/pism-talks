...
\begin{frame}{Glacier Change in Alaska: Columbia Glacier}
  ...
  \note{In Alaska, glaciers are changing too.}
  \note{Who has been to Columbia Glacier near Valdez?}
  \note{When British explorers first surveyed it in 1794, its terminus extended south to the northern edge of Heather Island, a small island near the mouth of Columbia Bay. The glacier held that position until 1980, when it began a rapid retreat that continues today.}
...
\note{Over the past three decades, the terminus had retreated more than 20 kilometers (12 miles). In some years, the terminus retreated more than a kilometer. The movement of the terminus stalled between 2000 and 2006, for example, because the Great Nunatak Peak and Kadin Peak (directly to the west) constricted the glacier's movement and held the ice in place.}
