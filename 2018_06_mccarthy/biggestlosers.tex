...
\graphicspath{{figures/}{add_figures/}}
...
\begin{frame}[plain]
  ...
  \note[item]{In Switzerland ``skiing'' always means downhill skiing, unlike here in Alaska where skiing usually means XC skiing}
\end{frame}
...
\begin{frame}{Melting Glaciers in Alaska: Columbia Glacier}
  \begin{figure}
   \movie[showcontrols=true,autostart,loop,width=12cm]{\includegraphics[width=12cm]{columbia-eis}}{../movies/columbia-eis.mov}
  \end{figure}
...
\begin{frame}{Melting Glaciers in Alaska}
  ...
  \item or about 1\,m of water in 20 years
  \end{itemize}
...
\begin{frame}{Ice Cores: The 2-mile Time Machine}
  ...
  \note[item]{Ice cores are like a big archive that}
  \note[item]{store information about past climate}
...
\begin{frame}{Attack from below}
 \begin{figure}
  \movie[showcontrols=true,autostart,loop,width=10cm]{\includegraphics[width=10cm]{gl-retreat}}{../movies/gl-retreat.mov}
  \end{figure}
...
\begin{frame}{West Antarctic Ice Sheet}
  \movie[showcontrols=true,width=10cm]{\includegraphics[width=10cm]{rignot-wais}}{../movies/rignot-wais.mov}
...
\begin{frame}
  \frametitle{Greenland: The next thousand years}
  \begin{figure}
   \movie[showcontrols=true,loop,width=7cm]{\includegraphics[width=7cm]{../movies/gris_g900m_rcps_0000}}{../movies/gris-g900m_rcps-hd1920.mov}
  \end{figure}
\end{frame}
...
\begin{frame}{The sun drives the glacial/interglacial cycle}
  ...
  \begin{block}{Milankovitch Cycle}
    \begin{figure}
      \movie[showcontrols=true,autostart,loop,width=8cm]{\includegraphics[width=8cm]{orbital-forcing}}{../movies/orbital-forcing.mov}
    \end{figure}
  \end{block}
  \begin{columns}[T]
...
\begin{frame}
    \begin{figure}
      \movie[showcontrols=true,loop,width=10cm]{\includegraphics[width=10cm]{alley-001}}{../movies/alley-milankovitch.mov}
    \end{figure}
